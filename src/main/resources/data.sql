...
insert into Addr (id, trip_id, rider_id, addr, lat, lng, has_arrived, boarding_time, arrival_time)
    values (30001, 20001, 10003, '210 Summerhill Dr, Ithaca, NY', 42.437409, -76.459810, false, now(), null);
